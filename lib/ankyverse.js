function getAnkyverseQuestionForToday(wink) {
  const questions = {
    resonanceWave1: {
      ...
      18: {
        en: "Consider the flow of emotions in your early experiences: What moments of joy and comfort do you remember that helped shape your feelings of security?",
        es: "Considera el flujo de emociones en tus primeras experiencias: ¿Qué momentos de alegría y comodidad recuerdas que ayudaron a dar forma a tus sentimientos de seguridad?",
      },
      19: {
        en: "Explore the concepts of personal power and will from your earliest memories: How did asserting yourself help you navigate your young world?",
        es: "Explora los conceptos de poder personal y voluntad desde tus primeros recuerdos: ¿Cómo te ayudó afirmarte a ti mismo a navegar en tu mundo juvenil?",
      },
      // Wink 12 - Unconditional Love: Heart Chakra
      20: {
        en: "Think about the nurturing elements in your early life: How did the acts of giving and receiving shape your understanding of love and compassion?",
        es: "Piensa en los elementos nutritivos en tus primeros años de vida: ¿Cómo moldearon los actos de dar y recibir tu comprensión del amor y la compasión?",
      },
      // Wink 13 - Expressive Truth: Throat Chakra
      21: {
