function getAnkyverseQuestionForToday(wink) {
  const questions = {
    resonanceWave1: {
      ...
      // Wink 11 - Empowerment: Solar Plexus Chakra
      11: {
        en: "Envision the surge of strength and determination that accompanied your first breath. How might this energy have sculpted your path and presence in the world?",
        es: "Visualiza el aumento de fuerza y determinación que acompañó tu primer aliento. ¿Cómo podría esta energía haber esculpido tu camino y presencia en el mundo?",
      },
