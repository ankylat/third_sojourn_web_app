...
function getAnkyverseQuestion(language = "en") {
  const question = {
    ...
    es: "Durante tu tiempo en el vientre de tu madre, ¿qué esperanzas y perspectivas tenían tus padres sobre el mundo y tu futuro? ¿Qué les importaba? ¿Cómo crees que esto influyó en tus primeras percepciones y entendimiento?",
  };
